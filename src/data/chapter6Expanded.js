...
export const ch6Echo = {
  fragments: [
    ...
    "The family he hid you with paid the price",
    "You survived alone in the rubble",
    "Your blood carries the storm home",
  ],
  correctOrder: [0, 1, 2, 3, 4],
  baseDC: 8,
  dreamText: "The vision is the clearest it has ever been. No symbols. No metaphor. No fragments. Just the truth, laid bare like a skeleton on a beach.\n\nZeus. A mortal woman named Alexis — dark-haired, strong-handed, brave enough to love a god and wise enough to know what it would cost. A child born with lightning curled in her tiny fists. Hera's wrath gathering on the horizon like a storm that has been building since the beginning of time.\n\nA desperate father — the most powerful being in the world, and powerless to protect his daughter from his own wife — sealing his child's power, layer by layer, like wrapping a flame in cloth. Giving her to Alexis, who didn't want to let go. Placing her with a family in Athens — kind strangers, good strangers, a blue door and a jasmine courtyard. Walking away without looking back.\n\nThen — fire. Not lightning. Divine fire, cold and precise. Hera's work. The blue door hanging from one hinge. The jasmine turning to ash. The family that loved you, erased in a single night. And you — impossibly — still breathing in the rubble, wrapped in something invisible and warm that held on when everything else let go.\n\nAn Oracle, watching. Waiting. A stranger with a hooded face pressing a parchment into a girl's hand. Six words. The thread is ready to be pulled.\n\nYour journey. Your blood. Your storm. Your grief.\n\nThe vision doesn't end this time. It simply becomes part of you — another chamber of your heart, one that was always there, just locked.",
  nightmareText: "Hera's face. Beautiful and terrible — the beauty of a blade, the terror of a smile that knows exactly what it's going to destroy and has all the time in the world to do it.\n\nYou see what she saw that night. The blue door. The jasmine. The family eating dinner — your brother laughing, your mother weaving, your father watching the sunset. Ordinary. Warm. Doomed.\n\nYou see her raise her hand. You see the fire — not hot, not orange, but white and cold and final, the fire of a god who destroys with precision.\n\nThen she turns. And she looks through the rubble. Through the smoke. Through the seal.\n\nShe sees you.\n\n\"I missed one,\" she whispers. Not angry. Patient. The patience of someone who has eternity and knows it.\n\n\"I won't miss again.\"",
};
...
export const ch6DreamData = {
  ...
  dreamText: "The dream is not a dream. It's a memory — but not yours.\n\nYou're seeing through Zeus's eyes.\n\nYou hold an infant. Impossibly small. Impossibly bright. Lightning flickers in her tiny fists — not dangerous, joyful, the electricity of a new life that doesn't know yet how extraordinary it is.\n\nYou feel his love. Vast and terrified and absolute. The love of the most powerful being in the world for the most fragile thing he's ever created.\n\nYou feel him seal the power away. Layer by layer. Like wrapping a flame in silk. Carefully. Gently. Each layer a promise: *I will come back for you. When it's safe. When you're ready.*\n\nYou feel him place the child with strangers — kind strangers, good strangers, strangers with a blue door and a jasmine courtyard — and walk away. Without looking back. Because if he looks back, he won't be able to leave.\n\nThen the dream lurches forward. Years pass in a heartbeat. And you feel what he felt the night the fire came.\n\nYou're on Olympus. You feel the pulse of Hera's power — cold, surgical, absolute — reaching toward Athens. Toward the blue door. You feel it hit. You feel the family shatter. And you feel the seal hold — your own power, buried in an infant's blood, wrapping around her in the rubble like a fist that will not open.\n\nShe survived. But they didn't. And you — Zeus, the king of everything — can't undo it. Can't bring them back. Can't even grieve aloud because the grief would tell Hera where to look next.\n\nYou wake with tears on your face that aren't yours. They're his.",
  nightmareText: "Hera's voice, whispering from every direction — from the stone, from the dark, from the flowers, from the water:\n\n\"I see you, little spark. I see you hiding in my husband's brother's domain. Did you think the dead could protect you? Did you think darkness could hide lightning?\"\n\nThe whisper curls around you like smoke.\n\n\"I burned the blue door. I burned the jasmine. I burned the woman who sang you lullabies and the boy who pressed his coin into your hand. And you — you I missed. That was careless of me.\"\n\nA pause. The pause of someone who does not make the same mistake twice.\n\n\"I won't be careless again.\"\n\nYou wake gasping. The ferryman is watching. His face is calm. His eyes are the steadiest thing in the Underworld.\n\n\"Bad dream?\" he asks. His voice doesn't waver. \"Dreams are louder down here. But they're also just dreams.\"\n\nHe doesn't say *she can't reach you.* He doesn't say *you're safe.* He says something better:\n\n\"I'm here. Rest.\"",
  communeText: "You sit in the dark, processing everything Persephone told you. Zeus. Your father. Alexis — your birth mother, who let you go so you could live. The family in Athens who took you in and loved you and died for it. Hera's fire. The rubble. The seal that saved you and condemned everyone else.\n\nIt all connects now. Every strange moment, every too-convenient rescue, every god who seemed to know more than they should. You weren't stumbling through a journey. You were being guided home. By people who loved you but couldn't say so — and by the guilt of a father who watched his plan destroy the people it was supposed to protect.\n\nThe ferryman sits nearby. Silent. After a very long time — long enough that the dark flowers have opened and closed twice — he speaks.\n\n\"Knowing who you are is not the same as deciding who you'll be.\" His voice is quiet enough to barely disturb the air. \"The first is a fact. The second is a choice.\"\n\nHe doesn't say anything else. He doesn't need to.",
...
export const ch6RivalConversation = {
  ...
  exchanges: [
    ...
    {
      kiraLine: "\"When we get back to the surface,\" Kira says, \"Hera is coming. She already burned your family out of the world once — and she missed you. She won't miss twice. Zeus's daughter, Ares's daughter — she won't care about the difference.\"\n\nShe looks at you directly. No games. No armor. Just a girl, sitting by a river in the land of the dead, saying something that matters.\n\n\"I'd rather face that with you than against you.\"",
      responses: [
        {
