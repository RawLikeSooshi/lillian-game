    ...
    <div style={bg}>
      <div style={{ ...card, marginBottom: 10, padding: "11px 16px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 7 }}>
          ...
          <span style={{ color: "#d4a017", fontSize: 10 }}>Choose Your Path</span>
        </div>
      ...
      <div style={{ display: "flex", gap: 16, maxWidth: 660, width: "100%", flexWrap: "wrap" }}>
        {fork.paths.map(path => (
          ...
          >
            ...
            <h3 style={{ fontSize: 15, color: "#d4a017", margin: "0 0 8px", fontFamily: "Georgia,serif" }}>{path.label}</h3>
            <p style={{ fontSize: 13, color: "#c8b88a", lineHeight: 1.7, margin: "0 0 10px", fontFamily: "Georgia,serif" }}>{path.description}</p>
